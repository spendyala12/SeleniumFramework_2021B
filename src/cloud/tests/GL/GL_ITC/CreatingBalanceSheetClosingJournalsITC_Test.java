...
import cloud.components.GL.GL_ITC.CreatingBalanceSheetClosingJournalsITC;
import cloud.components.common.Login;
import cloud.components.common.Navigate;

public class CreatingBalanceSheetClosingJournalsITC_Test extends BaseTest{
	@BeforeTest
	public void start(){
	...
	public void executeTest(String dataFile1,String sheet1,String scenario1) throws Exception{
		...
		Login.run(1);
		Navigate.run(1);
		CreatingBalanceSheetClosingJournalsITC.run(1);
	}
	@AfterTest
	public void end(){
		close();
