...
import cloud.components.GL.GL_ITC.GenerateAutomaticReversalsITC;
import cloud.components.common.Login;
import cloud.components.common.Navigate;
import itc.framework.BaseTest;

public class GenerateAutomaticReversalsITC_Test extends BaseTest {
	...
	public void executeTest(String dataFile1,String sheet1,String scenario1) throws Exception{
		...
		Login.run(1);
		Navigate.run(1);
		GenerateAutomaticReversalsITC.run(1);
	}
	@AfterTest
	public void end(){
		close();
