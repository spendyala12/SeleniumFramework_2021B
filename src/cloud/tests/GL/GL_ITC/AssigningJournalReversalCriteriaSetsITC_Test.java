...
import cloud.components.GL.GL_ITC.AssigningJournalReversalCriteriaSetsITC;
import cloud.components.common.Login;
import cloud.components.common.Navigate_More;

public class AssigningJournalReversalCriteriaSetsITC_Test extends BaseTest{
	@BeforeTest
	public void start(){
	...
	public void executeTest(String dataFile1,String sheet1,String scenario1) throws Exception{
		...
		Login.run(1);
		Navigate_More.run(1);
		AssigningJournalReversalCriteriaSetsITC.run(1);
	}
	@AfterTest
	public void end(){
		close();
