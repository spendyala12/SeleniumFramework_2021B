...
import cloud.components.FA.FA_ITC.PerformingACostRetirementITC;
import cloud.components.common.Login;
import itc.framework.BaseTest;

public class PerformingACostRetirementITC_Test extends BaseTest {
	...
	public void executeTest(String dataFile1,String sheet1,String scenario1) throws Exception{
		...
		testsheet = sheet1;
		Login.run(1);
		PerformingACostRetirementITC.run(1);
	}
	@AfterTest
	public void end(){
		close();
