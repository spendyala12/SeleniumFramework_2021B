...
import cloud.components.AR.AR_ITC.CalculatingTaxesOnAReceivablesTransactionITC;
import cloud.components.common.Login;
import itc.framework.BaseTest;

public class CalculatingTaxesOnAReceivablesTransactionITC_Test extends BaseTest {
	...
	public void executeTest(String dataFile1,String sheet1,String scenario1) throws Exception{
		...
		testsheet = sheet1;
		Login.run(1);
		CalculatingTaxesOnAReceivablesTransactionITC.run(1);
	}
	@AfterTest
	public void end(){
		close();
