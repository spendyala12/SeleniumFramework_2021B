...
import cloud.components.AR.AR_ITC.ApplyingAnOnAccountCreditMemoITC;
import cloud.components.common.Login;
import cloud.components.common.Navigate;
import itc.framework.BaseTest;

public class ApplyingAnOnAccountCreditMemoITC_Test extends BaseTest {
	...
	public void executeTest(String dataFile1,String sheet1,String scenario1) throws Exception{
		...
		Login.run(1);
		Navigate.run(1);
		ApplyingAnOnAccountCreditMemoITC.run(1);
	}
	@AfterTest
	public void end(){
		close();
