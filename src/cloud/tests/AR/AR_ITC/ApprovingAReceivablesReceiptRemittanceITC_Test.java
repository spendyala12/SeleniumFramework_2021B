...
import cloud.components.AR.AR_ITC.ApprovingAReceivablesReceiptRemittanceITC;
import cloud.components.common.Login;
import cloud.components.common.Navigate;
import itc.framework.BaseTest;

public class ApprovingAReceivablesReceiptRemittanceITC_Test extends BaseTest {
	...
	public void executeTest(String dataFile1,String sheet1,String scenario1) throws Exception{
		...
		Login.run(1);
		Navigate.run(1);
		ApprovingAReceivablesReceiptRemittanceITC.run(1);
