...
import cloud.components.AR.AR_ITC.ResearchingFundsCaptureTransactionsITC;
import cloud.components.common.Login;
import cloud.components.common.Navigate;
import itc.framework.BaseTest;

public class ResearchingFundsCaptureTransactionsITC_Test extends BaseTest {
	...
	public void executeTest(String dataFile1,String sheet1,String scenario1) throws Exception{
		...
		Login.run(1);
		Navigate.run(1);
		ResearchingFundsCaptureTransactionsITC.run(1);
