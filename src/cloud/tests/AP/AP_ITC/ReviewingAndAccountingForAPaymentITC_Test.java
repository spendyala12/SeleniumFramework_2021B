...
import cloud.components.AP.AP_ITC.ReviewingAndAccountingForAPaymentITC;
import cloud.components.common.Login;
import itc.framework.BaseTest;

public class ReviewingAndAccountingForAPaymentITC_Test extends BaseTest {
	...
	public void executeTest(String dataFile1,String sheet1,String scenario1) throws Exception{
		...
		testsheet = sheet1;
		Login.run(1);
		ReviewingAndAccountingForAPaymentITC.run(1);
