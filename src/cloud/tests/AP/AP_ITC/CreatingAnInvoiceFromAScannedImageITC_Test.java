...
import cloud.components.AP.AP_ITC.CreatingAnInvoiceFromAScannedImageITC;
import cloud.components.common.Login;
import itc.framework.BaseTest;

public class CreatingAnInvoiceFromAScannedImageITC_Test extends BaseTest {
	...
	public void executeTest(String dataFile1,String sheet1,String scenario1) throws Exception{
		...
		testsheet = sheet1;
		Login.run(1);
		CreatingAnInvoiceFromAScannedImageITC.run(1);
	}
	@AfterTest
	public void end(){
		close();
