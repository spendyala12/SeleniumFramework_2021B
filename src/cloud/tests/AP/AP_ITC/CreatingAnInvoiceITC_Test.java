...
import cloud.components.AP.AP_ITC.CreatingAnInvoiceITC;
import cloud.components.common.Login;
import itc.framework.BaseTest;

public class CreatingAnInvoiceITC_Test extends BaseTest {

	@BeforeTest
	public void start(){
		startUp("ie", this.getClass().getSimpleName()); 
	}
