...
public class CreatingReceiptsandApplyITC extends BaseTest{
	...
	private static void run() throws InterruptedException{
		...
		setElementText(By.xpath("//input[contains(@id, 'amountId::content')]"), EnteredAmount); //EnteredAmount
		...
		setElementText(By.xpath("//*[contains(@id, 'customerAccountId::content')]"), CustomerAccountNum); //CustomerAccountNumber
		...
		setElementText(By.xpath("//*[contains(@id, 'value60::content')]"), TransactionCustomerAccNum); //TransactionCustomerAccNum 
