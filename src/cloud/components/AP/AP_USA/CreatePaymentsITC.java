...
public class CreatePaymentsITC extends BaseTest{
	...
	public static String SelectionCriteriaPaymentMethod;
	...
	private static void run() throws Exception  {
		 ...
		 */
		clickElement(By.xpath("//span[contains(text(),'Payments')]")); //Payments
		...
		clickElement(By.xpath("//*[contains(text(),'T3INV1979')]"));
