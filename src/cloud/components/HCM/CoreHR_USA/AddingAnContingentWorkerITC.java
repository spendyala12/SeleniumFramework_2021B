...
public class AddingAnContingentWorkerITC extends BaseTest{
	...
	public static String ACAEligibility;
	public static String ACAFullTime;
	public static String LimitedNonAssessmentPeriod;
	...
	private static void run() throws Exception  {
		...
		Thread.sleep(1000);
		//setElementText(By.xpath("//*[contains(@id, 'SP1:selectOneChoice2::content')]"), PlacementReason);
		...
		//setElementText(By.xpath("//*[contains(@id, 'inputText19::content')]"), Address3);
		//setElementText(By.xpath("//*[contains(@id, 'inputText20::content')]"), Address4);
		...
		//setElementText(By.xpath("//*[contains(@id, 'PersonLegislativeIteratorVeteranSelfIdentification_DisplayUS::content')]"), VeteranSelfIdentificationStatus);
		clickElement(By.xpath("//*[contains(@id, 'SP1:tt1:next')]")); //Next
		Thread.sleep(1000);
		...
		//setElementText(By.xpath("//*[contains(@id, 'BaseWorkerAsgLegDDFIteratoracaEligibility_DisplayUS::content')]"), ACAEligibility); 
		//setElementText(By.xpath("//*[contains(@id, 'BaseWorkerAsgLegDDFIteratorACAFullTime_DisplayUS::content')]"), ACAFullTime);
		//setElementText(By.xpath("//*[contains(@id, 'BaseWorkerAsgLegDDFIteratorlimitedNonassessmentPeriod_DisplayUS::content')]"), LimitedNonAssessmentPeriod);
		...
		setElementText(By.xpath("//*[contains(@id, 'BaseWorkerAsgDFFIteratortimecardRequired_Display__FLEX_EMPTY::content')]"), TimeCardReq); //TimeCardReq
		...
		clickElement(By.xpath("//*[contains(@id, 'AddCw1:2:SP2:AddCw1:0:r2:0:AT1:_ATp:cil113::icon')]"));  //click + Under Payroll details
		clickElement(By.xpath("//*[contains(@id, 'selectOneChoice1::lovIconId')]")); //Payroll drop down
		clickElement(By.xpath("//span[contains(text(),'"+Payroll+"')]"));  //US Bi Weekly Payroll
