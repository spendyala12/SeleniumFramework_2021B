...
import cloud.components.iExpense.iExpense_USA.AuditingExpenseReportITC;
...
public class AuditingExpenseReportITC extends BaseTest {
	...
	private static void run() throws InterruptedException{
		...
		clickElement(By.xpath("//*[contains(@id, 'pt1:panelGroupLayout2:qryId0:value10::content')]"));  
...
//		clickElement(By.xpath("//*[contains(@id, 'pt1:panelGroupLayout2:qryId0:value60::content')]"));  
