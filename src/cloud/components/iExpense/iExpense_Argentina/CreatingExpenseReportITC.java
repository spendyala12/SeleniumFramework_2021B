...
import cloud.components.iExpense.iExpense_Argentina.CreatingExpenseReportITC;
...
public class CreatingExpenseReportITC extends BaseTest {
	...
	private static void run() throws InterruptedException{
		...
		Thread.sleep(5000);
		setElementText(By.xpath("//*[contains(@id,'is1::content')]"), Amount);   //ARS Argentine Peso
		setElementText(By.xpath("//*[contains(@id,'AP1:ReceiptAmount::content')]"), Amount1);   //10
		Thread.sleep(5000);		
		...
		browser.findElement(By.xpath("//*[contains(@id,'Description::content')]")).sendKeys(Description);   //description
		Thread.sleep(5000);
